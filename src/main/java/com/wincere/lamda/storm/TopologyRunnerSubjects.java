...
import com.wincere.lamda.storm.bolt.SimpleMongoBolt;
import com.wincere.lamda.storm.bolt.SubjectMongoBolt;
...
public class TopologyRunnerSubjects {
	...
	public static void main(String ar[]){
		...
		builder.setBolt("MongoBolt", new SubjectMongoBolt("172.16.1.171", 27017, "mock", "mastertable5")).shuffleGrouping("kafka-spout");
		//Configuration
