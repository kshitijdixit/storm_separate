...
public class TopologyRunner1 {
	...
	public static void main(String ar[]){
		...
		builder.setBolt("MongoBolt", new SimpleMongoBolt("172.16.1.186", 27017, "mock", "neerajRocks18")).shuffleGrouping("kafka-spout");
		//Configuration
		//System.setProperty("storm.jar", "/home/neeraj/development/storm_separate/target/storm_separate-1.0-SNAPSHOT-jar-with-dependencies.jar");
		...
		conf.put("kafka.spout.topic", "test4"); // This was not being read from the property 
		...
		try {
			StormSubmitter.submitTopology("Vertica-Storage-Toplogie33", conf, builder.createTopology());
