...
public class TopologyRunnerMasterTable {
	...
	public static void main(String ar[]){
		...
		builder.setBolt("MongoBolt", new MasterTAbleSimpleMongoBolt("172.16.1.171", 27017, "mock", "mastertable5")).shuffleGrouping("kafka-spout");
		//Configuration
