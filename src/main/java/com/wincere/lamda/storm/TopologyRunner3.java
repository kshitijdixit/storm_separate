...
public class TopologyRunner3 {
	...
	public static void main(String ar[]){
		...
		builder.setBolt("MongoBolt", new SimpleMongoBolt("172.16.1.186", 27017, "mock", "neerajRocks8")).fieldsGrouping("VerticaBolt",new Fields("values"));
		//Configuration
