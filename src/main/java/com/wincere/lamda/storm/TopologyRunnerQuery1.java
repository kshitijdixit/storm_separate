...
public class TopologyRunnerQuery1 {
	...
	public static void main(String ar[]){
		...
		conf.put("kafka.spout.topic", "test"); // This was not being read from the property 
	...
	/*	LocalCluster cluster = new LocalCluster();
		...
		try {
			StormSubmitter.submitTopology("UCAP-Topology", conf, builder.createTopology());
